...
import { DeveshMark } from "@/components/devesh-mark";
import { DeveshWordmark } from "@/components/devesh-wordmark";
      ...
      <BrandContextMenu>
        <div className="grid grid-cols-[2rem_1fr]">
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <DeveshMark className="h-8 w-auto sm:h-12" />
          </div>
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <DeveshWordmark className="h-18 lg:h-28" />
          </div>
        </div>
      </BrandContextMenu>
    </Panel>
