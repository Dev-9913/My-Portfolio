# AI Agent Guidelines for https://deveshkaushik.vercel.app

This guide provides essential information for AI agents working with the https://deveshkaushik.vercel.app codebase - a Next.js dev portfolio, blog, and component registry website.

## Project Overview

**https://deveshkaushik.vercel.app** is a minimal, pixel-perfect dev portfolio, component registry, and blog built with modern web technologies. It serves as:

- Personal portfolio for Devesh Kaushik (@Dev-9913)
...
npm run registry:internal:build
